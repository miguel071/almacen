...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label8->Location = System::Drawing::Point(594, 46);
			...
			this->button5->Location = System::Drawing::Point(313, 547);
			...
			this->button4->Location = System::Drawing::Point(183, 547);
			...
			// txtprecven
			// 
			this->txtprecven->Location = System::Drawing::Point(183, 491);
			...
			// txtprecos
			// 
			this->txtprecos->Location = System::Drawing::Point(183, 450);
			...
			// txtmodelo
			// 
			this->txtmodelo->Location = System::Drawing::Point(183, 409);
			...
			// txtmarca
			// 
			this->txtmarca->Location = System::Drawing::Point(183, 369);
			...
			// txtdescripcion
			// 
			this->txtdescripcion->Location = System::Drawing::Point(183, 327);
			...
			// txtcantidad
			// 
			this->txtcantidad->Location = System::Drawing::Point(183, 288);
			...
			// txtcodproducto
			// 
			this->txtcodproducto->Location = System::Drawing::Point(183, 252);
			...
			this->label7->Location = System::Drawing::Point(12, 493);
			...
			this->label6->Location = System::Drawing::Point(12, 452);
			...
			this->label5->Location = System::Drawing::Point(12, 411);
			...
			this->label2->Location = System::Drawing::Point(12, 290);
			...
			this->listAccesorios->Location = System::Drawing::Point(481, 149);
			...
			this->button3->Location = System::Drawing::Point(50, 547);
			...
			// pictureBox2
			// 
			this->pictureBox2->ImageLocation = L"C:\\ProProgra\\gestiondatos\\imagenes\\general\\acces.png";
